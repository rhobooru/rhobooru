...
class RecordTest extends TestCase
{
    ...
    /**
     * Adding a Tag to a Record must increment that Record's cached tag count.
     *
     * @test
    ...
    public function adding_tag_should_increment_cached_field()
    {
        ...
        $this->assertEquals(1, Record::first()->cache_tag_count);
    }

    /**
     * Removing a Tag from a Record must decrement that Record's cached tag count.
     *
     * @test
     * @covers \App\Observers\RecordTagObserver::deleting
    ...
    public function removing_tag_should_decrement_cached_field()
    {
        ...
        Record::first()->tags()->detach($tag);

        $this->assertEquals(0, Record::first()->cache_tag_count);
    }
